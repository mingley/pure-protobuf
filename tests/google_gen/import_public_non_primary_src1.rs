...
mod __gen {
    ...
    impl pbrs::__internal::SealedInternal for NonPrimarySrcPubliclyImportedEnum1 {}
    impl pbrs::Proxied for NonPrimarySrcPubliclyImportedEnum1 {
        type View<'msg> = NonPrimarySrcPubliclyImportedEnum1;
    }
    impl pbrs::AsView for NonPrimarySrcPubliclyImportedEnum1 {
        type Proxied = Self;
        fn as_view(&self) -> Self {
            *self
        }
    }
    impl<'msg> pbrs::IntoView<'msg> for NonPrimarySrcPubliclyImportedEnum1 {
