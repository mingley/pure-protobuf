...
mod __gen {
    ...
    pub use crate::no_package_import::*;
    #[repr(transparent)]
    #[derive(Clone, Copy, PartialEq, Eq, Hash, PartialOrd, Ord)]
    pub struct EnumWithoutPackage(i32);
    #[allow(non_upper_case_globals)]
    impl EnumWithoutPackage {
        pub const Unspecified: EnumWithoutPackage = EnumWithoutPackage(0);
    ...
    impl From<EnumWithoutPackage> for i32 {
        fn from(v: EnumWithoutPackage) -> i32 {
            v.0
        }
    }
    impl TryFrom<i32> for EnumWithoutPackage {
    ...
    impl Default for EnumWithoutPackage {
        fn default() -> Self {
            Self(0)
        }
    }
    impl std::fmt::Debug for EnumWithoutPackage {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            if let Some(n) = self.constant_name() {
                write!(f, "EnumWithoutPackage::{n}")
            } else {
                write!(f, "EnumWithoutPackage::from({})", self.0)
            }
        }
    }
    impl protobuf::__internal::SealedInternal for EnumWithoutPackage {}
    impl protobuf::Proxied for EnumWithoutPackage {
        type View<'msg> = EnumWithoutPackage;
    }
    impl protobuf::AsView for EnumWithoutPackage {
        type Proxied = Self;
        fn as_view(&self) -> Self {
            *self
        }
    }
    impl<'msg> protobuf::IntoView<'msg> for EnumWithoutPackage {
    ...
    impl Enum for EnumWithoutPackage {
        const NAME: &'static str = "EnumWithoutPackage";
        fn is_known(value: i32) -> bool {
            matches!(value, 0)
        }
    }
    #[derive(Clone, Debug)]
    pub struct MsgWithoutPackage {
        unknown: UnknownFields,
        cached_size: protobuf::rt::CachedSize,
    }
    impl PartialEq for MsgWithoutPackage {
        fn eq(&self, other: &Self) -> bool {
            self.unknown == other.unknown
        }
    }
    impl Eq for MsgWithoutPackage {}
    impl Default for MsgWithoutPackage {
        #[inline(always)]
        fn default() -> Self {
            unsafe { protobuf::rt::zeroed_message() }
        }
    }
    impl MsgWithoutPackage {
        pub fn new() -> Self {
            Self::default()
        }
        pub const EMPTY_PARSE_OK: bool = true;
        pub const FULL_NAME: &'static str = "MsgWithoutPackage";
        #[inline(always)]
    ...
    protobuf::impl_typed_message!(
        MsgWithoutPackage,
        MsgWithoutPackageView,
        MsgWithoutPackageMut
    );
}
