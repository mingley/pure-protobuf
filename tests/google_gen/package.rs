...
mod __gen {
    ...
    impl pbrs::__internal::SealedInternal for EnumWithPackage {}
    impl pbrs::Proxied for EnumWithPackage {
        type View<'msg> = EnumWithPackage;
    }
    impl pbrs::AsView for EnumWithPackage {
        type Proxied = Self;
        fn as_view(&self) -> Self {
            *self
        }
    }
    impl<'msg> pbrs::IntoView<'msg> for EnumWithPackage {
    ...
    pbrs::impl_typed_message!(MsgWithPackage, MsgWithPackageView, MsgWithPackageMut);
}
