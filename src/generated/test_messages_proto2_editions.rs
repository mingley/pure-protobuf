                ...
                match n {
                    1 => match w {
                        pbrs::rt::WIRE_LEN => {
                            let (s, e) = pbrs::rt::read_len_span(data, pos)?;
                            let b = &data[s..e];
                            self.data = Some(Box::new(pbrs::rt::LazyStr::from_span(wire, s, e)));
                        }
                        _ => self
                            .unknown
                            .fields
                ...
                match n {
                    ...
                    2 => match w {
                        pbrs::rt::WIRE_LEN => {
                            let (s, e) = pbrs::rt::read_len_span(data, pos)?;
                            let b = &data[s..e];
                            self.concept = Some(Box::new(pbrs::rt::LazyStr::from_span(wire, s, e)));
                        }
                        _ => self
                            .unknown
                            .fields
                    ...
                    3 => match w {
                        pbrs::rt::WIRE_LEN => {
                            let (s, e) = pbrs::rt::read_len_span(data, pos)?;
                            let b = &data[s..e];
                            self.requires.push(pbrs::rt::LazyStr::from_span(wire, s, e));
                        }
                        _ => self
                            .unknown
                            .fields
                ...
                match n {
                    25 => match w {
                        pbrs::rt::WIRE_LEN => {
                            let (s, e) = pbrs::rt::read_len_span(data, pos)?;
                            let b = &data[s..e];
                            self.str = Some(Box::new(pbrs::rt::LazyStr::from_span(wire, s, e)));
                        }
                        _ => self
                            .unknown
                            .fields
                    ...
                    10 => match w {
                        pbrs::rt::WIRE_LEN => {
                            ...
                            if self.sub_msg.is_some() {
                                ...
                                self.sub_msg = pbrs::rt::LazyMsg::from_wire(wire.window(s, e));
                            }
                        }
                        _ => self
                            .unknown
                    ...
                    1 => match w {
                        pbrs::rt::WIRE_LEN => {
                            ...
                            if self.a1.is_some() {
                                ...
                                self.a1 = pbrs::rt::LazyMsg::from_wire(wire.window(s, e));
                            }
                        }
                        _ => self
                            .unknown
                    ...
                    2 => match w {
                        pbrs::rt::WIRE_LEN => {
                            ...
                            if self.a2.is_some() {
                                ...
                                self.a2 = pbrs::rt::LazyMsg::from_wire(wire.window(s, e));
                            }
                        }
                        _ => self
                            .unknown
                    ...
                    3 => match w {
                        pbrs::rt::WIRE_LEN => {
                            ...
                            if self.a3.is_some() {
                                ...
                                self.a3 = pbrs::rt::LazyMsg::from_wire(wire.window(s, e));
                            }
                        }
                        _ => self
                            .unknown
                    ...
                    4 => match w {
                        pbrs::rt::WIRE_LEN => {
                            ...
                            if self.a4.is_some() {
                                ...
                                self.a4 = pbrs::rt::LazyMsg::from_wire(wire.window(s, e));
                            }
                        }
                        _ => self
                            .unknown
                    ...
                    5 => match w {
                        pbrs::rt::WIRE_LEN => {
                            ...
                            if self.a5.is_some() {
                                ...
                                self.a5 = pbrs::rt::LazyMsg::from_wire(wire.window(s, e));
                            }
                        }
                        _ => self
                            .unknown
