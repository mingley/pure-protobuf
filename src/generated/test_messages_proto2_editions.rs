...
mod __gen {
    ...
    impl EnumOnlyProto2 {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            ...
            let desc = pool
                .get_message("protobuf_test_messages.editions.proto2.EnumOnlyProto2")
    ...
    impl ForeignMessageProto2 {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            ...
            let pool = generated_pool();
            let desc = pool
                .get_message("protobuf_test_messages.editions.proto2.ForeignMessageProto2")
                .ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
    ...
    impl GroupField {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            ...
            let pool = generated_pool();
            let desc = pool
                .get_message("protobuf_test_messages.editions.proto2.GroupField")
                .ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
    ...
    impl NullHypothesisProto2 {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            ...
            let pool = generated_pool();
            let desc = pool
                .get_message("protobuf_test_messages.editions.proto2.NullHypothesisProto2")
                .ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
    ...
    impl OneStringProto2 {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            ...
            let pool = generated_pool();
            let desc = pool
                .get_message("protobuf_test_messages.editions.proto2.OneStringProto2")
                .ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
    ...
    impl ProtoWithKeywords {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            ...
            let pool = generated_pool();
            let desc = pool
                .get_message("protobuf_test_messages.editions.proto2.ProtoWithKeywords")
                .ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
    ...
    impl TestAllRequiredTypesProto2 {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            ...
            let pool = generated_pool();
            let desc = pool
                .get_message("protobuf_test_messages.editions.proto2.TestAllRequiredTypesProto2")
                .ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
    ...
    impl MessageSetCorrect {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            let b = pbrs::Serialize::serialize(self).map_err(|_| SerializeError::new("json"))?;
            let pool = generated_pool();
            let desc = pool.get_message("protobuf_test_messages.editions.proto2.TestAllRequiredTypesProto2.MessageSetCorrect").ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
        }
        ...
        pub fn from_json_ignore(json: &str, ignore: bool) -> Result<Self, ParseError> {
            let pool = generated_pool();
            let desc = pool.get_message("protobuf_test_messages.editions.proto2.TestAllRequiredTypesProto2.MessageSetCorrect").ok_or_else(|| ParseError::owned("missing desc".into()))?;
            let d = pbrs::DynamicMessage::from_json_with_pool(desc, Some(pool), json, ignore)?;
            let b = pbrs::Serialize::serialize(&d).map_err(|e| ParseError::owned(e.to_string()))?;
            <Self as pbrs::Parse>::parse(&b)
        }
    ...
    impl MessageSetCorrectExtension1 {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            let b = pbrs::Serialize::serialize(self).map_err(|_| SerializeError::new("json"))?;
            let pool = generated_pool();
            let desc = pool.get_message("protobuf_test_messages.editions.proto2.TestAllRequiredTypesProto2.MessageSetCorrectExtension1").ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
        }
        ...
        pub fn from_json_ignore(json: &str, ignore: bool) -> Result<Self, ParseError> {
            let pool = generated_pool();
            let desc = pool.get_message("protobuf_test_messages.editions.proto2.TestAllRequiredTypesProto2.MessageSetCorrectExtension1").ok_or_else(|| ParseError::owned("missing desc".into()))?;
            let d = pbrs::DynamicMessage::from_json_with_pool(desc, Some(pool), json, ignore)?;
            let b = pbrs::Serialize::serialize(&d).map_err(|e| ParseError::owned(e.to_string()))?;
            <Self as pbrs::Parse>::parse(&b)
        }
    ...
    impl MessageSetCorrectExtension2 {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            let b = pbrs::Serialize::serialize(self).map_err(|_| SerializeError::new("json"))?;
            let pool = generated_pool();
            let desc = pool.get_message("protobuf_test_messages.editions.proto2.TestAllRequiredTypesProto2.MessageSetCorrectExtension2").ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
        }
        ...
        pub fn from_json_ignore(json: &str, ignore: bool) -> Result<Self, ParseError> {
            let pool = generated_pool();
            let desc = pool.get_message("protobuf_test_messages.editions.proto2.TestAllRequiredTypesProto2.MessageSetCorrectExtension2").ok_or_else(|| ParseError::owned("missing desc".into()))?;
            let d = pbrs::DynamicMessage::from_json_with_pool(desc, Some(pool), json, ignore)?;
            let b = pbrs::Serialize::serialize(&d).map_err(|e| ParseError::owned(e.to_string()))?;
            <Self as pbrs::Parse>::parse(&b)
        }
    ...
    impl NestedMessage {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            let b = pbrs::Serialize::serialize(self).map_err(|_| SerializeError::new("json"))?;
            let pool = generated_pool();
            let desc = pool.get_message("protobuf_test_messages.editions.proto2.TestAllRequiredTypesProto2.NestedMessage").ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
        }
        ...
        pub fn from_json_ignore(json: &str, ignore: bool) -> Result<Self, ParseError> {
            let pool = generated_pool();
            let desc = pool.get_message("protobuf_test_messages.editions.proto2.TestAllRequiredTypesProto2.NestedMessage").ok_or_else(|| ParseError::owned("missing desc".into()))?;
            let d = pbrs::DynamicMessage::from_json_with_pool(desc, Some(pool), json, ignore)?;
            let b = pbrs::Serialize::serialize(&d).map_err(|e| ParseError::owned(e.to_string()))?;
            <Self as pbrs::Parse>::parse(&b)
        }
    ...
    impl TestAllTypesProto2 {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            ...
            let pool = generated_pool();
            let desc = pool
                .get_message("protobuf_test_messages.editions.proto2.TestAllTypesProto2")
                .ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
    ...
    impl TestAllTypesProto2Data {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            ...
            let pool = generated_pool();
            let desc = pool
                .get_message("protobuf_test_messages.editions.proto2.TestAllTypesProto2.Data")
                .ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
    ...
    impl TestAllTypesProto2MessageSetCorrectExtension1 {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            let b = pbrs::Serialize::serialize(self).map_err(|_| SerializeError::new("json"))?;
            let pool = generated_pool();
            let desc = pool.get_message("protobuf_test_messages.editions.proto2.TestAllTypesProto2.MessageSetCorrectExtension1").ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
        }
        ...
        pub fn from_json_ignore(json: &str, ignore: bool) -> Result<Self, ParseError> {
            let pool = generated_pool();
            let desc = pool.get_message("protobuf_test_messages.editions.proto2.TestAllTypesProto2.MessageSetCorrectExtension1").ok_or_else(|| ParseError::owned("missing desc".into()))?;
            let d = pbrs::DynamicMessage::from_json_with_pool(desc, Some(pool), json, ignore)?;
            let b = pbrs::Serialize::serialize(&d).map_err(|e| ParseError::owned(e.to_string()))?;
            <Self as pbrs::Parse>::parse(&b)
        }
    ...
    impl TestAllTypesProto2MessageSetCorrectExtension2 {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            let b = pbrs::Serialize::serialize(self).map_err(|_| SerializeError::new("json"))?;
            let pool = generated_pool();
            let desc = pool.get_message("protobuf_test_messages.editions.proto2.TestAllTypesProto2.MessageSetCorrectExtension2").ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
        }
        ...
        pub fn from_json_ignore(json: &str, ignore: bool) -> Result<Self, ParseError> {
            let pool = generated_pool();
            let desc = pool.get_message("protobuf_test_messages.editions.proto2.TestAllTypesProto2.MessageSetCorrectExtension2").ok_or_else(|| ParseError::owned("missing desc".into()))?;
            let d = pbrs::DynamicMessage::from_json_with_pool(desc, Some(pool), json, ignore)?;
            let b = pbrs::Serialize::serialize(&d).map_err(|e| ParseError::owned(e.to_string()))?;
            <Self as pbrs::Parse>::parse(&b)
        }
    ...
    impl TestLargeOneof {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            ...
            let pool = generated_pool();
            let desc = pool
                .get_message("protobuf_test_messages.editions.proto2.TestLargeOneof")
                .ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
    ...
    impl A1 {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            ...
            let pool = generated_pool();
            let desc = pool
                .get_message("protobuf_test_messages.editions.proto2.TestLargeOneof.A1")
                .ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
    ...
    impl A2 {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            ...
            let pool = generated_pool();
            let desc = pool
                .get_message("protobuf_test_messages.editions.proto2.TestLargeOneof.A2")
                .ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
    ...
    impl A3 {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            ...
            let pool = generated_pool();
            let desc = pool
                .get_message("protobuf_test_messages.editions.proto2.TestLargeOneof.A3")
                .ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
    ...
    impl A4 {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            ...
            let pool = generated_pool();
            let desc = pool
                .get_message("protobuf_test_messages.editions.proto2.TestLargeOneof.A4")
                .ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
    ...
    impl A5 {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            ...
            let pool = generated_pool();
            let desc = pool
                .get_message("protobuf_test_messages.editions.proto2.TestLargeOneof.A5")
                .ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
    ...
    impl UnknownToTestAllTypes {
        ...
        pub fn to_json(&self) -> Result<String, SerializeError> {
            ...
            let pool = generated_pool();
            let desc = pool
                .get_message("protobuf_test_messages.editions.proto2.UnknownToTestAllTypes")
                .ok_or_else(|| SerializeError::new("missing desc"))?;
            pbrs::DynamicMessage::parse_with_pool(desc, Some(pool), &b)
                .map_err(|_| SerializeError::new("json"))?
                .to_json()
