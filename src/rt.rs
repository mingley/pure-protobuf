...
pub use crate::lazy::{LazyBytes, LazyMsg, LazyStr, MergeBytes, Wire, require_utf8};
...
pub use crate::wire::{
    ...
    WIRE_VARINT, WireOut, capture_unknown, check_size, decode_tag, decode_varint, decode_zigzag32,
    decode_zigzag64, encode_len_field, encode_len_header, encode_tag, encode_varint,
...
impl CachedSize {
    ...
    pub fn get(&self) -> Option<u64> {
        ...
        if v == Self::DIRTY { None } else { Some(v) }
    }
