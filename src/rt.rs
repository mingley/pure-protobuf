...
pub use crate::wire::{
    ...
    encode_zigzag64, key_len_value_len, read_fixed32, read_fixed64, read_len_bytes, skip_field,
    tag_len, varint_len, UnknownField, UnknownFields, WIRE_EGROUP, WIRE_I32, WIRE_I64, WIRE_LEN,
