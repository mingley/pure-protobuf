...
fn generated_stubs_name_encoding_cancel_and_stream_drop() {
    ...
    assert!(
        ...
        "generated server on_response rustdoc must Distinct generated client on_response Err Call fail after receive from this generated server on_response Err trailers-only after handler Ok"
    );
    assert!(
        src.contains(
