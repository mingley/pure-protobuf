...
fn reflection_crate_docs_name_interceptor_wait_for_ready() {
    ...
    assert!(
        ...
        "reflection crate rustdoc must Distinct handler Err after the handler ran from this reflection interceptor Err without reading the body"
    );
    assert!(
        src.contains(
    ...
    assert!(
        ...
        "reflection crate rustdoc must Distinct client interceptor Err local reject never opens a stream from this reflection interceptor Err without reading the body"
    );
    assert!(
        src.contains(
        ...
        "reflection crate rustdoc must Distinct client on_response Err Call fail after receive from this reflection interceptor Err without reading the body"
    );
    assert!(
        src.contains(
        ...
        "reflection crate rustdoc must Distinct StreamSender fail after any messages already sent from this reflection interceptor Err without reading the body"
    );
    assert!(
        src.contains(
    ...
    assert!(
        ...
        "reflection crate rustdoc must Distinct interceptor Err without reading the body from this reflection handler Err after the handler ran"
    );
    assert!(
        src.contains(
    ...
    assert!(
        ...
        "reflection crate rustdoc must Distinct client on_response Err Call fail after receive from this reflection handler Err after the handler ran"
    );
    assert!(
        src.contains(
    ...
    assert!(
        ...
        "reflection crate rustdoc must name Outgoing::connected live-socket snapshot on ServerReflectionInfo"
    );
    assert!(
        src.contains(
    ...
    assert!(
        ...
        "reflection crate rustdoc must Distinct reflection handler Err after the handler ran from this reflection client interceptor Err local reject never opens a stream"
    );
    assert!(
        src.contains(
    ...
    assert!(
        ...
        "reflection crate rustdoc must Distinct interceptor Err without reading the body from this reflection client interceptor Err local reject never opens a stream"
    );
    assert!(
        src.contains(
        ...
        "reflection crate rustdoc must Distinct StreamSender fail after any messages already sent from this reflection client interceptor Err local reject never opens a stream"
    );
    assert!(
        src.contains(
    ...
    assert!(
        ...
        "reflection crate rustdoc must Distinct server on_response Err trailers-only after handler Ok from this reflection StreamSender fail after any messages already sent"
    );
    assert!(
        src.contains(
        ...
        "reflection crate rustdoc must Distinct client interceptor Err local reject never opens a stream from this reflection StreamSender fail after any messages already sent"
    );
    assert!(
        src.contains(
        ...
        "reflection crate rustdoc must Distinct client on_response Err Call fail after receive from this reflection StreamSender fail after any messages already sent"
    );
    assert!(
        src.contains(
    ...
    assert!(
        ...
        "reflection crate rustdoc must Distinct interceptor Err without reading the body from this reflection server on_response Err trailers-only after handler Ok"
    );
    assert!(
        src.contains(
        ...
        "reflection crate rustdoc must Distinct reflection client on_response Err Call fail after receive from this reflection server on_response Err trailers-only after handler Ok"
    );
    assert!(
        src.contains(
        ...
        "reflection crate rustdoc must Distinct StreamSender fail after any messages already sent from this reflection server on_response Err trailers-only after handler Ok"
    );
    assert!(
        src.contains(
    ...
    assert!(
        ...
        "reflection crate rustdoc must Distinct interceptor Err without reading the body from this reflection client on_response Err Call fail after receive"
    );
    assert!(
        src.contains(
    ...
    assert!(
        ...
        "reflection crate rustdoc must Distinct reflection server on_response Err trailers-only after handler Ok from this reflection client on_response Err Call fail after receive"
    );
    assert!(
        src.contains(
