...
HTTP/2 PING keepalive, max connection age and idle, automatic redial of a dead
connection, graceful drain with `GOAWAY`, per-message gzip, deadlines,
cancellation, ASCII and `-bin` metadata, and OK-path custom trailers.

**[Guide](../docs/grpc.md)** — building services, streaming, metadata, errors,
deadlines, compression, interceptors, limits, tuning, testing, and writing a
service without codegen.
