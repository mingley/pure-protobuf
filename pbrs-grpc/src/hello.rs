...
//! Distinct from a hello server intercept Err: that is trailers without reading the body; this hello client on_response Err fails the Call after a successful receive.
...
//! Distinct from a hello server on_response Err: that is trailers-only after handler Ok; this hello client on_response Err fails the Call after a successful receive.
//! Distinct from a hello StreamSender fail: that is trailers after any messages already sent; this hello client on_response Err fails the Call after a successful receive.
...
//! Distinct from a hello client on_response Err: that fails the Call after a successful receive; this hello server intercept Err is trailers without reading the body.
