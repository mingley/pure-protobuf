...
//! | Rich errors | [`pb`], [`ErrorDetails`], [`Status::with_error_details`], [`Status::from_error_details`], [`Status::rpc`], [`Status::error_details`], [`Status::from_rpc`], [`Status::set_rpc`], [`Status::set_error_details`], [`Status::set_from_error_details`], [`Status::from_error`], [`Status::with_cause`], [`Status::is_retryable`], [`Status::retry_delay`], [`pb::RetryInfo::with_retry_delay`], [`Status::error_info`], [`pb::ErrorInfo::with_reason`], [`pb::ErrorInfo::with_metadata`], [`Status::bad_request`], [`pb::BadRequest::with_field`], [`pb::FieldViolation::with_field`], [`pb::bad_request`], [`Status::quota_failure`], [`pb::QuotaFailure::with_violation`], [`pb::quota_failure`], [`Status::precondition_failure`], [`pb::PreconditionFailure::with_violation`], [`pb::precondition_failure`], [`Status::help`], [`pb::Help::with_link`], [`pb::help`], [`Status::localized_message`], [`pb::LocalizedMessage::with_locale`], [`Status::request_info`], [`pb::RequestInfo::with_request_id`], [`Status::resource_info`], [`pb::ResourceInfo::with_resource`], [`Status::debug_info`], [`pb::DebugInfo::with_stack`] |
