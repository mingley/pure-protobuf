...
//! | Envelopes | [`Request`], [`Parts`], [`Response`], [`ResponseParts`], [`Metadata`], [`Status`], [`Code`], [`Code::from_i32`], [`Code::to_i32`], [`Code::name`], [`Code::description`], [`ParseCodeError`], [`Any`] |
//! | Rich errors | [`pb`], [`Any::pack`], [`Any::pack_with`], [`Any::is`], [`Any::unpack`], [`ErrorDetails`], [`ErrorDetails::new`], [`ErrorDetails::to_anys`], [`ErrorDetails::from_rpc`], [`Status::new`], [`Status::from_code`], [`Status::set_code`], [`Status::with_code`], [`Status::set_message`], [`Status::with_message`], [`Status::with_error_details`], [`Status::from_error_details`], [`Status::with_details`], [`pb::Status::with_details`], [`Status::details`], [`Status::rpc`], [`Status::error_details`], [`Status::from_rpc`], [`Status::set_rpc`], [`Status::set_details`], [`Status::set_error_details`], [`Status::set_from_error_details`], [`Status::with_rpc`], [`Status::from_error`], [`Status::with_cause`], [`Status::is_retryable`], [`Status::retry_delay`], [`pb::Duration::from_std`], [`pb::Duration::try_to_std`], [`pb::RetryInfo::with_retry_delay`], [`Status::error_info`], [`pb::ErrorInfo::with_reason`], [`pb::ErrorInfo::with_metadata`], [`Status::bad_request`], [`pb::BadRequest::with_field`], [`pb::FieldViolation::with_field`], [`pb::bad_request`], [`Status::quota_failure`], [`pb::QuotaFailure::with_violation`], [`pb::quota_failure::Violation::with_subject`], [`pb::quota_failure`], [`Status::precondition_failure`], [`pb::PreconditionFailure::with_violation`], [`pb::precondition_failure::Violation::with_type`], [`pb::precondition_failure`], [`Status::help`], [`pb::Help::with_link`], [`pb::help::Link::with_url`], [`pb::help`], [`Status::localized_message`], [`pb::LocalizedMessage::with_locale`], [`Status::request_info`], [`pb::RequestInfo::with_request_id`], [`Status::resource_info`], [`pb::ResourceInfo::with_resource`], [`Status::debug_info`], [`pb::DebugInfo::with_stack`] |
