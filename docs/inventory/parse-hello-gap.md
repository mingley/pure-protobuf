Source: closed [#32](https://github.com/mingley/pure-protobuf/pull/32). Harness: `parse-leftover/parse-hello-gap/`.
...
```
cd parse-leftover/parse-hello-gap && cargo run --release
```
