...
- Native gRPC is `pbrs-grpc`. Official `grpc.testing` TestService interop
  ...
  Distinct from a packed-status handler Err: that is after the handler ran; this packed-status interceptor Err is a local reject never opens a stream.
  Distinct from a packed-status server on_response Err: that is trailers-only after handler Ok; this packed-status interceptor Err is a local reject never opens a stream.
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status interceptor Err is a local reject never opens a stream.
  Distinct from a packed-status server intercept Err: that is trailers without reading the body; this packed-status interceptor Err is a local reject never opens a stream.
  ...
  Distinct from a packed-status handler Err: that is after the handler ran; this packed-status server intercept Err is trailers without reading the body.
  ...
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status server intercept Err is trailers without reading the body.
  Distinct from a packed-status interceptor Err: that is a local reject never opens a stream; this packed-status server intercept Err is trailers without reading the body.
  ...
  Distinct from a packed-status handler Err: that is after the handler ran; this packed-status server on_response Err is trailers-only after handler Ok.
  ...
  Distinct from a packed-status Store interceptor Err: that is trailers without reading the body; this packed-status server on_response Err is trailers-only after handler Ok.
  ...
  Distinct from a packed-status TestService interceptor Err: that is trailers without reading the body; this packed-status server on_response Err is trailers-only after handler Ok.
  ...
  Distinct from a packed-status Reverser interceptor Err: that is trailers without reading the body; this packed-status server on_response Err is trailers-only after handler Ok.
  Distinct from a packed-status Reverser StreamSender fail: that is trailers after any messages already sent; this packed-status server on_response Err is trailers-only after handler Ok.
  ...
  Distinct from a packed-status Health interceptor Err: that is trailers without reading the body; this packed-status Channel on_response Err fails the Call after a successful receive.
  ...
  Distinct from a packed-status Store client interceptor Err: that is a local reject never opens a stream; this packed-status Channel on_response Err fails the Call after a successful receive.
  Distinct from a packed-status Store interceptor Err: that is trailers without reading the body; this packed-status Channel on_response Err fails the Call after a successful receive.
  ...
  Distinct from a packed-status TestService client interceptor Err: that is a local reject never opens a stream; this packed-status Channel on_response Err fails the Call after a successful receive.
  ...
  Distinct from a packed-status hello interceptor Err: that is trailers without reading the body; this packed-status Channel on_response Err fails the Call after a successful receive.
  ...
  Distinct from a packed-status UnimplementedService client interceptor Err: that is a local reject never opens a stream; this packed-status Channel on_response Err fails the Call after a successful receive.
  ...
  `Target` is `host:port`, not a `grpc://` / `grpcs://` URI. Distinct from tonic `https://` (also `INVALID_ARGUMENT`). `Channel::connect_tls` dials TLS; a `grpcs://` URI is not a silent TLS dial. A `grpc://` URI is `INVALID_ARGUMENT`.
  ...
  `quota_failure::Violation::with_quota_value` builds a nested quota value on this packed-status.
  `quota_failure::Violation::with_future_quota_value` builds a nested future quota value on this packed-status.
  ...
  `PreconditionFailure::with_violation_entry` builds an extra packed precondition violation on this packed-status.
  ...
  `ErrorDetails::with_localized_message` plants packed LocalizedMessage on this packed-status bag.
  `ErrorDetails::with_unknown` plants a non-standard Any on this packed-status bag.
  ...
  `Status::details` returns raw trailer bytes on this packed-status, Distinct from `message` being the ASCII `grpc-message` trailer.
  `Status::code` is the ASCII `grpc-status` trailer on this packed-status, Distinct from `details` returning raw trailer bytes.
  ...
  Distinct from a packed-status Health handler Err: that is after the handler ran; this packed-status Health StreamSender fail is trailers after any messages already sent.
  Distinct from a packed-status Health interceptor Err: that is trailers without reading the body; this packed-status Health StreamSender fail is trailers after any messages already sent.
  Distinct from a packed-status server on_response Err: that is trailers-only after handler Ok; this packed-status Health StreamSender fail is trailers after any messages already sent.
  Distinct from a packed-status Health client interceptor Err: that is a local reject never opens a stream; this packed-status Health StreamSender fail is trailers after any messages already sent.
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status Health StreamSender fail is trailers after any messages already sent.
  `Status::from_error_details` is the typed bag after this packed-status reflection StreamSender fail on a server response producer; those trailers ship after any messages already sent.
  Distinct from a packed-status reflection handler Err: that is after the handler ran; this packed-status reflection StreamSender fail is trailers after any messages already sent.
  Distinct from a packed-status reflection interceptor Err: that is trailers without reading the body; this packed-status reflection StreamSender fail is trailers after any messages already sent.
  Distinct from a packed-status server on_response Err: that is trailers-only after handler Ok; this packed-status reflection StreamSender fail is trailers after any messages already sent.
  Distinct from a packed-status reflection client interceptor Err: that is a local reject never opens a stream; this packed-status reflection StreamSender fail is trailers after any messages already sent.
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status reflection StreamSender fail is trailers after any messages already sent.
  `Status::from_error_details` is the typed bag after this packed-status Store StreamSender fail on a server response producer; those trailers ship after any messages already sent.
  ...
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status Store StreamSender fail is trailers after any messages already sent.
  ...
  Distinct from a packed-status TestService client interceptor Err: that is a local reject never opens a stream; this packed-status TestService StreamSender fail is trailers after any messages already sent.
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status TestService StreamSender fail is trailers after any messages already sent.
  ...
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status hello StreamSender fail is trailers after any messages already sent.
  ...
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status InteropTestService StreamSender fail is trailers after any messages already sent.
  ...
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status Health interceptor Err is trailers without reading the body.
  ...
  Distinct from a packed-status server on_response Err: that is trailers-only after handler Ok; this packed-status reflection interceptor Err is trailers without reading the body.
  Distinct from a packed-status reflection client interceptor Err: that is a local reject never opens a stream; this packed-status reflection interceptor Err is trailers without reading the body.
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status reflection interceptor Err is trailers without reading the body.
  ...
  Distinct from a packed-status Store client interceptor Err: that is a local reject never opens a stream; this packed-status Store handler Err is after the handler ran.
  Distinct from a packed-status server on_response Err: that is trailers-only after handler Ok; this packed-status Store handler Err is after the handler ran.
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status Store handler Err is after the handler ran.
  ...
  Distinct from a packed-status server on_response Err: that is trailers-only after handler Ok; this packed-status Health handler Err is after the handler ran.
  ...
  Distinct from a packed-status Health handler Err: that is after the handler ran; this packed-status Health client interceptor Err is a local reject never opens a stream.
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status Health client interceptor Err is a local reject never opens a stream.
  ...
  Distinct from a packed-status Health interceptor: that runs on the inbound RPC before the handler; this packed-status Health client interceptor runs on the outbound call before the stream opens.
  ...
  Distinct from a packed-status server on_response Err: that is trailers-only after handler Ok; this packed-status reflection handler Err is after the handler ran.
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status reflection handler Err is after the handler ran.
  ...
  Distinct from a packed-status reflection handler Err: that is after the handler ran; this packed-status reflection client interceptor Err is a local reject never opens a stream.
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status reflection client interceptor Err is a local reject never opens a stream.
  Distinct from a packed-status reflection interceptor Err: that is trailers without reading the body; this packed-status reflection client interceptor Err is a local reject never opens a stream.
  Distinct from a packed-status reflection StreamSender fail: that is trailers after any messages already sent; this packed-status reflection client interceptor Err is a local reject never opens a stream.
  ...
  Distinct from a packed-status server on_response Err: that is trailers-only after handler Ok; this packed-status Reverser interceptor Err is trailers without reading the body.
  Distinct from a packed-status Reverser client interceptor Err: that is a local reject never opens a stream; this packed-status Reverser interceptor Err is trailers without reading the body.
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status Reverser interceptor Err is trailers without reading the body.
  ...
  Distinct from a packed-status Reverser handler Err: that is after the handler ran; this packed-status Reverser client interceptor Err is a local reject never opens a stream.
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status Reverser client interceptor Err is a local reject never opens a stream.
  ...
  Distinct from `Channel::max_concurrent_rpcs`: that takes a slot when the `Call` is polled; this packed-status Reverser client interceptor already ran, so a local Err never consumes that budget.
  ...
  Distinct from a packed-status server on_response Err: that is trailers-only after handler Ok; this packed-status hello interceptor Err is trailers without reading the body.
  ...
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status hello interceptor Err is trailers without reading the body.
  ...
  Distinct from a packed-status hello client interceptor Err: that is a local reject never opens a stream; this packed-status hello handler Err is after the handler ran.
  Distinct from a packed-status server on_response Err: that is trailers-only after handler Ok; this packed-status hello handler Err is after the handler ran.
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status hello handler Err is after the handler ran.
  ...
  Distinct from a packed-status hello handler Err: that is after the handler ran; this packed-status hello client interceptor Err is a local reject never opens a stream.
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status hello client interceptor Err is a local reject never opens a stream.
  Distinct from a packed-status hello interceptor Err: that is trailers without reading the body; this packed-status hello client interceptor Err is a local reject never opens a stream.
  Distinct from a packed-status hello StreamSender fail: that is trailers after any messages already sent; this packed-status hello client interceptor Err is a local reject never opens a stream.
  ...
  Distinct from a packed-status hello interceptor: that runs on the inbound RPC before the handler; this packed-status hello client interceptor runs on the outbound call before the stream opens.
  ...
  Distinct from a packed-status UnimplementedService handler Err: that is after the handler ran; this packed-status UnimplementedService interceptor Err is trailers without reading the body.
  Distinct from a packed-status server on_response Err: that is trailers-only after handler Ok; this packed-status UnimplementedService interceptor Err is trailers without reading the body.
  ...
  Distinct from a packed-status server on_response Err: that is trailers-only after handler Ok; this packed-status UnimplementedService handler Err is after the handler ran.
  ...
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status UnimplementedService client interceptor Err is a local reject never opens a stream.
  ...
  Distinct from a packed-status server on_response Err: that is trailers-only after handler Ok; this packed-status InteropTestService interceptor Err is trailers without reading the body.
  Distinct from a packed-status InteropTestService client interceptor Err: that is a local reject never opens a stream; this packed-status InteropTestService interceptor Err is trailers without reading the body.
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status InteropTestService interceptor Err is trailers without reading the body.
  ...
  Distinct from a packed-status InteropTestService client interceptor Err: that is a local reject never opens a stream; this packed-status InteropTestService handler Err is after the handler ran.
  Distinct from a packed-status server on_response Err: that is trailers-only after handler Ok; this packed-status InteropTestService handler Err is after the handler ran.
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status InteropTestService handler Err is after the handler ran.
  Distinct from a packed-status InteropTestService StreamSender fail: that is trailers after any messages already sent; this packed-status InteropTestService handler Err is after the handler ran.
  ...
  Distinct from a packed-status InteropTestService handler Err: that is after the handler ran; this packed-status InteropTestService client interceptor Err is a local reject never opens a stream.
  ...
  Distinct from a packed-status InteropTestService interceptor: that runs on the inbound RPC before the handler; this packed-status InteropTestService client interceptor runs on the outbound call before the stream opens.
  ...
  Distinct from a packed-status server on_response Err: that is trailers-only after handler Ok; this packed-status TestService interceptor Err is trailers without reading the body.
  ...
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status TestService interceptor Err is trailers without reading the body.
  ...
  Distinct from a packed-status TestService client interceptor Err: that is a local reject never opens a stream; this packed-status TestService handler Err is after the handler ran.
  Distinct from a packed-status server on_response Err: that is trailers-only after handler Ok; this packed-status TestService handler Err is after the handler ran.
  Distinct from a packed-status Channel on_response Err: that fails the Call after a successful receive; this packed-status TestService handler Err is after the handler ran.
  Distinct from a packed-status TestService StreamSender fail: that is trailers after any messages already sent; this packed-status TestService handler Err is after the handler ran.
  ...
  Distinct from a packed-status TestService interceptor Err: that is trailers without reading the body; this packed-status TestService client interceptor Err is a local reject never opens a stream.
